...
can3.width = can2.width*2;
can3.height = can2.height*2;
    ...
    for(let i = 0; i < objsL.length; i++){
        ...
        if(img){
            if(o.upright){
                ...
                else nob.drawImage_basic_replace_dep(img,o.x-img.w/2,o.y-img.h-o.z,white,o.col,o.y+(o.z*nob.height),o.upright);
            }
...
document.addEventListener("keydown",e=>{
    ...
    if(key == "arrowright" || key == "arrowleft"){
        if(!me.smallInvOpen) if(!me.spellMenuOpen){
