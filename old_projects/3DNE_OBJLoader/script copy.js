...
var cancelCount = 0;
function renderObject(x=nob.centerX,y=nob.centerY,z=0){
  ...
  tree.rz = -(mouseX%(360*2))*Math.PI/180/2;
  tree.rx = -(180-mouseY%(360*2))*Math.PI/180/2;
  ...
  function drawFace(i,i2,i3,i4,faceI){
    ...
    //let cc = [colors[faceI],colors[faceI+1],colors[faceI+2],255];
    let cc = [dep*0.9,dep*0.4,dep*0.2,255];
...
function update(){
  ...
  nob.dep = new Uint32Array(nob.ssize);
